# Sudo
A starter repo for building our employee management database system with React, Express.js, and Sequelize.js
...
You will need to have postgres downloaded onto your machine

Create a user in postgres named 'username' with the password 'password':
...
```
createdb -h localhost -U username app2019_development
```
